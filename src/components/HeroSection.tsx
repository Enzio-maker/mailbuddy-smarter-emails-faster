    ...
    <section className="relative overflow-hidden pt-28 pb-16 md:pt-36 md:pb-24 lg:pt-44 lg:pb-32">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{ background: "var(--hero-gradient)", filter: "blur(100px)", animationDelay: "2s" }}
        />
        <div className="absolute top-1/4 right-[15%] h-16 w-16 rounded-2xl border border-primary/10 bg-primary/5 animate-float" />
        <div className="absolute bottom-1/3 left-[12%] h-12 w-12 rounded-full border border-primary/10 bg-primary/5 animate-float" style={{ animationDelay: "3s" }} />
        <div className="absolute top-1/3 left-[20%] h-8 w-8 rounded-lg border border-primary/8 bg-primary/4 animate-float" style={{ animationDelay: "1.5s" }} />
      </div>
